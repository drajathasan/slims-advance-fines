...
<div class="menuBoxInner loanRulesIcon">
    ...
    <div class="sub_section">
	    <div class="btn-group">
		    <a href="<?= pluginUrl(); ?>" class="btn btn-default"><?php echo __('Loan Rules List'); ?></a>
		    <a href="<?= pluginUrl(['action' => 'detail']); ?>" class="btn btn-default"><?php echo __('Add New Loan Rules'); ?></a>
	    </div>
        <form name="search" action="<?= pluginUrl(); ?>" id="search" method="get" class="form-inline">
            <?php echo __('Search'); ?>
